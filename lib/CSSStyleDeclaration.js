...
var dashedToCamelCase = require('./parsers.js').dashedToCamelCase;
    ...
    cssText: {
        ...
        set: function (value) {
            ...
            for (i = 0; i < rule_length; ++i) {
                name = dummyRule[i];
                if (setter = this.__lookupSetter__(dashedToCamelCase(name))) {
                    setter.call(this, dummyRule.getPropertyValue(name))
                }
